...
import { Switch, Route, BrowserRouter as Router, Redirect } from 'react-router-dom'
  ...
  function NuevoAdministrador ({props}){
  ...
  <div className={classes.modal}>
      <h2>¿Deseas guardar el contacto?</h2>
      <h4>El contacto no podrá ser editado una vez guardado</h4>
    ...
    //     }
    //     try {  
    //         ContactosRequests.postNewEmployee(newEmployee)
    //         .then((res)=>{
    //             if(res.code == 204){
    ...
    //         toast.error('Ocurrió un error al registrar contacto.', {
    //             position: "top-right",
    //             autoClose: 5000,
    //             hideProgressBar: false,
    //             closeOnClick: true,
  ...
  return (
    ...
    <div style={{height:400, width:'100%',alignItems:'center', justifyContent:'center', marginLeft:'1%'}}>
        ...
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
            <h1 style={{color:'#003DA5'}}>Nuevo contacto</h1>
        </div>
