...
export default function ZonaH ()  {
    ...
    const leftToolbarTemplate = () => {
        return (
            <React.Fragment>
                <Button label="Nueva Zona" icon="pi pi-plus" className="p-button-success mr-2" onClick={openNew} />
                <Button style={{marginLeft:2}} label="Eliminar Zona" icon="pi pi-trash" className="p-button-danger" onClick={confirmDeleteSelected} disabled={!selectedProducts || !selectedProducts.length} />
            </React.Fragment>
        )
    }
        ...
        <div className="datatable-crud-demo">
            ...
            <div className="card">
                ...
                <DataTable ref={dt} value={datas} selection={selectedProducts} onSelectionChange={(e) => setSelectedProducts(e.value)}
                    ...
                    <Column field="timeZoneName" header="Zona" sortable style={{ minWidth: '12rem' }}></Column>
